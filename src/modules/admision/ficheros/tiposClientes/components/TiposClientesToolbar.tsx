import type { RecordStatus } from "../../types/tiposClientes.types";
import type { StatusFilter } from "../hooks/useTiposClientes";
import { SelectMenu, type SelectOption } from "../../../../../shared/ui/SelectMenu";

export default function TiposClientesToolbar(props: {
  q: string;
    ...
    <div className="w-full">
      <div className="flex flex-wrap items-center gap-2 lg:flex-nowrap">
        <input
          ...
          placeholder="Buscar por código, tipo de cliente, etc."
          className={[
