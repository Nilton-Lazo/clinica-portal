...
import type { Mode } from "../hooks/useTiposIafas";
import { StatusBadge } from "../../components/StatusBadge";
import { SelectMenu, type SelectOption } from "../../../../../shared/ui/SelectMenu";
import { DangerButton, PrimaryButton, SecondaryButton } from "../../../../../shared/ui/buttons";

export default function TipoIafaFormCard(props: {
  mode: Mode;
  selected: TipoIafa | null;
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <div className="text-xs text-(--color-text-secondary)">
            {mode === "new" ? "Crea un tipo de IAFAS." : "Modifica campos y guarda cambios."}
          </div>
        </div>
