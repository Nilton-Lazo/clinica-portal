import type { ParamOption, RecordStatus } from "../types/paramOption.types";
...
export default function ParamOptionFormCard(props: {
  entityLabel: string;
  mode: Mode;
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <div className="text-xs text-(--color-text-secondary)">
            {mode === "new" ? `Crea un ${entityLabel}.` : "Modifica campos y guarda cambios."}
          </div>
        </div>
