...
const options = [
  {
    ...
    description:
      "Gestiona áreas o jefaturas para la configuración del módulo de Caja.",
  ...
  },
  {
    ...
    description:
      "Gestiona tipos de documento para la configuración del módulo de Caja.",
    icon: FileText,
  },
  {
    ...
    description:
      "Gestiona series y correlativos por tipo de documento para Caja.",
    icon: Hash,
  },
  {
    ...
    label: "Forma de pago",
    description:
      "Gestiona formas de pago para la configuración del módulo de Caja.",
    icon: HandCoins,
  },
  {
    ...
    label: "Medio de pago",
    description:
      "Gestiona medios de pago y su relación con formas de pago activas.",
    icon: WalletCards,
  },
  {
