...
import type { StatusFilter } from "../tarifas/hooks/useTarifas";
          ...
          right={
            <TarifaFormCard
              ...
              selected={
                vm.selected
                  ? {
                      codigo: vm.selected.codigo,
                      estado: vm.selected.estado,
                      tarifa_base: vm.selected.tarifa_base,
                    }
                  : null
              }
              codigo={vm.codigo}
